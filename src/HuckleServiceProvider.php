...
final class HuckleServiceProvider extends PackageServiceProvider
{
     ...
     *
     * Registers Blade directives for template config access and optionally
     * auto-exports all configuration to environment variables when configured.
     ...
     * - @huckle('path.to.node.field'): Outputs a config field value with auto-escaping
