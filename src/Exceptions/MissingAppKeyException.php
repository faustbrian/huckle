...
{
    /**
     * Creates an exception for missing APP_KEY configuration.
     *
     * This static factory method creates a new exception instance with a descriptive
     * message indicating that APP_KEY is not configured in the environment.
     *
     * @return self New exception instance with configured message
     */
