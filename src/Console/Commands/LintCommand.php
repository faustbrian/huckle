...
final class LintCommand extends Command
{
     ...
     *
     * Provides multiple validation options including syntax checking, expiration
     * monitoring, rotation tracking, file permission auditing, and environment
     * variable table display with context-based filtering capabilities.
     *
     * @var string
     */
     ...
     *
     * Filters nodes based on context (partition, environment, provider, country)
     * from command options and displays their exported environment variables in
     * a formatted table. Shows partition, environment, node name, variable names,
     * and truncated values for readability.
     *
     * @param Collection<string, Node> $nodes The leaf nodes to display
     */
    private function showExportsTable(Collection $nodes): void
    {
