...
final class ConfigDecryptCommand extends Command
{
     ...
     * encryption key specification, cipher algorithm selection, environment handling,
     * output path customization, and file cleanup behavior.
     *
     * @var string
     */
     ...
     * stripping when using Laravel's application key. The explicit --key option
