...
final class Parser
{
     ...
     */
    private const array BLOCK_TYPES = ['defaults', 'group', 'credential', 'export', 'connect', 'environment', 'provider', 'country', 'service', 'carrier', 'organization', 'team', 'user', 'region', 'client', 'continent', 'state', 'zone', 'fallback', 'partition', 'tenant', 'namespace', 'division', 'entity'];
