...
final class HuckleParser
{
     ...
     *
     * Tokenizes the HCL content, parses it into an AST, validates geographic
     * labels if enabled, and returns a HuckleConfig wrapper for easy access.
     *
     ...
     * @return HuckleConfig        The parsed and validated configuration object
     */
     ...
     *
     * Reads and validates file accessibility before parsing. Provides detailed
     * exceptions for file system errors to aid troubleshooting.
     *
     * @param  string              $path Absolute or relative path to the HCL file
     ...
     * Returns a result array instead of throwing exceptions for integration into
     ...
     * array instead of throwing exceptions for integration into validation workflows.
     *
     * @param  string                                    $path Absolute or relative path to the HCL file
     * @return array{valid: bool, errors: array<string>} Validation result with success flag and error messages
     */
