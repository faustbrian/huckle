 ...
 * division > environment > provider > country > service. Each level can define
...
final readonly class Division
{
     ...
     *
     * @param string                              $name         Division identifier typically representing a business unit,
     *                                                          region, or organizational division (e.g., "FI", "SE", "EE")
     * @param array<string, mixed>                $fields       Field definitions at the division level that can be inherited
     *                                                          and overridden by nested environments, providers, and countries
     * @param array<string, string>               $exports      Environment variable export mappings at the division level,
     ...
     * Context keys: division, environment, provider, country, service.
     *
     * @param array<string, string> $context Context filter map defining which division, environment,
