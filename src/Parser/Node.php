...
final readonly class Node
{
     ...
     * @param array<string, string> $configs     Laravel config path mappings (e.g., "cashier.key" => "pk_live_xxx")
     ...
     *
     * @return string Dot-separated path (e.g., "FI.production.posti")
     */
     ...
     * Get all field names.
     *
     * @return array<string> Field names defined on this node
     */
    ...
    /**
     * Get Laravel config path mappings with resolved values.
     *
     * @return array<string, string> Key-value map of config paths to resolved values
     */
     ...
     *
     * @return null|string Resolved command or null if not found
     */
     ...
     *
     * @return array<string> Connection names defined on this node
     */
     ...
     *
     * @param int $days Number of days to consider "soon" (default: 30)
     *
     * @return bool True if expiring within the specified days
     */
     ...
     *
     * @param array<string> $tags Tag identifiers
     *
     ...
     *
     * A node matches if all context keys match the node's path or type.
     * Context keys: partition, tenant, environment, provider, country, service.
     *
     * @param array<string, string> $context Context filter to match against
     *
     * @return bool True if all context criteria match
     */
     ...
     *
     * @return null|self The child node or null if not found
     */
