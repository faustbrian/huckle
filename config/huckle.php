...
return [
    ...
    | your credential definitions, groups, and export mappings.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When enabled, Huckle will automatically export all credential values
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Credentials that haven't been rotated within this many days will be
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Credentials that will expire within this many days will be flagged
