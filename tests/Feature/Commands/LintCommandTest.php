...
describe('LintCommand', function (): void {
    ...
    describe('table output', function (): void {
        test('displays environment variables table with --table flag', function (): void {
            Config::set('huckle.path', testFixture('basic.hcl'));

            $this->artisan('huckle:lint', ['--table' => true])
                ->expectsOutputToContain('Environment Variables:')
                ->expectsOutputToContain('Total:')
                ->assertExitCode(0);
        });

        test('filters table by partition', function (): void {
            Config::set('huckle.path', testFixture('basic.hcl'));
        ...
        test('filters table by environment', function (): void {
            Config::set('huckle.path', testFixture('basic.hcl'));
        ...
        test('filters table by partition and environment combined', function (): void {
            Config::set('huckle.path', testFixture('basic.hcl'));
        ...
        test('shows warning when no nodes match filter criteria', function (): void {
            Config::set('huckle.path', testFixture('basic.hcl'));
            ...
            $this->artisan('huckle:lint', [
                ...
                ->expectsOutputToContain('No nodes found matching the filter criteria')
                ->assertExitCode(0);
        });

        test('filters table by provider', function (): void {
            Config::set('huckle.path', testFixture('nested-hierarchy.hcl'));
        ...
        test('filters table by country', function (): void {
            Config::set('huckle.path', testFixture('nested-hierarchy.hcl'));
        ...
        test('works with nodes that have no exports', function (): void {
            Config::set('huckle.path', testFixture('basic.hcl'));
        ...
        test('works with all filter options combined', function (): void {
            Config::set('huckle.path', testFixture('nested-hierarchy.hcl'));
