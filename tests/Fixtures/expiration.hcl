...
group "expired" "production" {
  ...
  credential "recently_expired" {
    ...
    expires  = "2025-12-01"  # Recently expired
    rotated  = "2025-12-01"
  }
}
...
group "rotation" "production" {
  ...
  credential "recently_rotated" {
    ...
    expires  = "2026-06-01"  # Not expired
    rotated  = "2026-01-21"  # Recent rotation (41 days ago from 2026-03-03, within 90-day window)
  }
}
...
group "expiring" "production" {
  credential "expiring_soon" {
    ...
    expires  = "2026-03-19"  # Expiring soon (16 days from 2026-03-03, within 30-day window)
    rotated  = "2025-10-01"
  }
  ...
  credential "expiring_later" {
    ...
    expires  = "2026-04-14"  # Expiring later (42 days from 2026-03-03, within 90 but not 30)
    rotated  = "2025-11-01"
  }
  ...
  credential "not_expiring" {
    ...
    expires  = "2026-09-01"  # Not expiring soon (182 days from 2026-03-03)
    rotated  = "2025-11-01"
  }
}
