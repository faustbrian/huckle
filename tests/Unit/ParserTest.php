    ...
    describe('parse', function (): void {
        ...
        test('throws on invalid block type', function (): void {
            expect(fn (): array => parse('invalid_block { }'))
                ->toThrow(ParserException::class, "Invalid block type 'invalid_block'");
        });
