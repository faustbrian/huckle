...
Define and execute CLI connection commands for credentials like database clients, SSH, and APIs.

**Use case:** Quick access to database shells, SSH connections, and other CLI tools using stored credentials.

## Defining Connections

Add `connect` blocks inside credentials:
...
```bash
# List connections for a credential
...
$names = $credential->connectionNames();
// ['psql', 'pgadmin']

// Get a specific connection command
$psqlCommand = $credential->connection('psql');
